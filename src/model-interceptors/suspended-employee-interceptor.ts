...
export class SuspendedEmployeeInterceptor
  implements ModelInterceptorContract<SuspendedEmployee>
{
  ...
  receive(model: SuspendedEmployee): SuspendedEmployee {
    ...
    model.mawaredEmployeeIdInfo &&
      (model.mawaredEmployeeIdInfo = MawaredEmployee.createInstance(
        model.mawaredEmployeeIdInfo,
      ));
    ...
    model.signerInfo &&
      (model.signerInfo = AdminResult.createInstance(model.signerInfo));
    model.statusInfo &&
