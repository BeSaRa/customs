...
export class InternalUserOUInterceptor
  implements ModelInterceptorContract<InternalUserOU>
{
  ...
  receive(model: InternalUserOU): InternalUserOU {
    ...
    model.organizationUnitInfo &&
      (model.organizationUnitInfo = AdminResult.createInstance(
        model.organizationUnitInfo,
      ));
